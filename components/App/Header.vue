...
<template>
  <header ref="headerRef" :style="styles" class="fixed top-0 w-full z-50">
    <UContainer as="nav">
      <ul
        class="flex items-center my-4 px-3 text-sm font-medium text-gray-800 rounded-full shadow-lg bg-white/90 shadow-gray-800/5 ring-1 backdrop-blur dark:bg-gray-800/50 dark:text-gray-200 dark:ring-gray-700 ring-gray-900/5"
      >
